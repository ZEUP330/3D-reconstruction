...
callback(std_msgs::Int64 num)
{
    ...
    if (pcd_index > 1){
        ...
        filename1 = "/home/donyan/Desktop/kinect/src/scanner/data/" + std::to_string(pcd_index-1) + ".pcd";
        ...
        filename2 = "/home/donyan/Desktop/kinect/src/scanner/data/" + std::to_string(pcd_index) + ".pcd";
